...
- 장소 1 꼬밥: 따뜻하고 정겨운 분위기 / 적용한 class: `page-store`
  / 적용한 CSS:
  - 베이지색과 주황색을 사용해 따뜻한 느낌을 표현했다.
  - `Georgia`, `Batang` 글꼴을 사용해 정겨운 분위기를 만들었다.
...
### 출처
- 본문 글꼴: 컴퓨터에 설치된 `"Noto Sans KR"`,
  `"Malgun Gothic"`, `Georgia`, `"Batang"`, `"Arial Black"`을 사용했다.
- 외부 웹폰트 파일이나 웹폰트 서비스는 사용하지 않았다.